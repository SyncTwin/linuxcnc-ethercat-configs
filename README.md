...
работающего железа, а в README рядом написано, обо что мы спотыкались. Репозиторий
для тех, кто настраивает LinuxCNC руками.
...
| [`csv-velocity-spindle/`](csv-velocity-spindle/) | привод как шпиндель: скоростной режим CSV, масштаб скорости, проверка по счётчику вала | Wecon VD3E |
| [`reading-esi/`](reading-esi/) | как читать ESI и мануал привода: identity 0x1018, SDO-Info, вендорские объекты, глава про PDO | опыт четырёх вендоров |
| [`tripod-3prs/`](tripod-3prs/) | кастомная кинематика для halcompile: исходник целиком и разбор, как пишется kins-модуль | 3-PRS наклонная голова |
